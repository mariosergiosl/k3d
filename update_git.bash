...
export GIT_CONFIG_GLOBAL="C:/Syncfolder/GitHub/mariosergiosl/.gitconfig"
export GIT_CREDENTIALS="C:/Syncfolder/GitHub/mariosergiosl/.git-credentials"
if [ -f "C:/Syncfolder/GitHub/mariosergiosl/.github_token" ]; then
  export GITHUB_TOKEN=$(cat "C:/Syncfolder/GitHub/mariosergiosl/.github_token")
fi
